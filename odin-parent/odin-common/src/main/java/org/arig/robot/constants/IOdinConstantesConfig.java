...
public interface IOdinConstantesConfig {
    ...
    double asservTimeS = IOdinConstantesConfig.asservTimeMs / 1000;
    ...
    int pathFindingTailleObstacle = IOdinConstantesConfig.pathFindingSeuilProximite * 2 + 50;
