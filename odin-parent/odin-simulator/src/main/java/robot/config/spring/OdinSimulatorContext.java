...
import robot.constants.IConstantesI2COdinSimulator;
...
public class OdinSimulatorContext {
    ...
    public SD21Servos servos() {
        return new SD21Servos(IConstantesI2COdinSimulator.SERVO_DEVICE_NAME);
    }
    ...
    public ARIG2WheelsEncoders encoders(ResourcePatternResolver patternResolver) {
        ...
        return new BouchonARIG2WheelsEncoders(IConstantesI2COdinSimulator.CODEUR_MOTEUR_GAUCHE, IConstantesI2COdinSimulator.CODEUR_MOTEUR_DROIT, values);
    }
