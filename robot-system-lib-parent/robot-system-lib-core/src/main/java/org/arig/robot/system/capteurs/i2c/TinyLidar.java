  ...
  public Integer readValue() {
    ...
    try {
      ...
      if (res > 9) {
        ...
        switch (res) {
          case 1:
            errorMessage = "VL53L0 Status Code: Sigma Fail";
            break;
          case 2:
            errorMessage = "VL53L0 Status Code: Signal Fail";
            break;
          case 3:
            errorMessage = "VL53L0 Status Code: Min Range Fail";
            break;
          case 4:
            errorMessage = "VL53L0 Status Code: Phase Fail [Out of Range]";
            break;
          default:
            errorMessage = UNKNOWN_RESULT;
        }
    ...
    try {
      ...
      switch (data[0]) {
        case 0x43:
          ...
          break;
        case 0x4c:
          operationMode = "Single Step / Ultra Low Power";
          break;
        case 0x52:
          operationMode = "Real time";
          break;
        default:
          operationMode = UNKNOWN_RESULT;
      }
      ...
      switch (data[1]) {
        case 0x53:
          presetConfig = "High Speed";
          break;
        case 0x52:
          presetConfig = "Long Range";
          break;
        case 0x41:
          presetConfig = "High Accuracy";
          break;
        case 0x43:
          presetConfig = "Custom";
          break;
        case 0x54:
          presetConfig = "tinyLiDAR";
          break;
        default:
          presetConfig = UNKNOWN_RESULT;
      }
