...
public class JoyConRight extends JoyCon {
    ...
    private static final List<JoyConButton> rightButtons = new ArrayList<>();
    static {
        // Shared register
        sharedButtons.add(JoyConConstants.plus);
        sharedButtons.add(JoyConConstants.rightStick);
        sharedButtons.add(JoyConConstants.home);

        // Left register
        rightButtons.add(JoyConConstants.y);
        rightButtons.add(JoyConConstants.x);
        rightButtons.add(JoyConConstants.b);
        rightButtons.add(JoyConConstants.a);
        rightButtons.add(JoyConConstants.sr);
        rightButtons.add(JoyConConstants.sl);
        rightButtons.add(JoyConConstants.r);
        rightButtons.add(JoyConConstants.zr);
    }

    public JoyConRight(JoyConEventListener eventListener) {
