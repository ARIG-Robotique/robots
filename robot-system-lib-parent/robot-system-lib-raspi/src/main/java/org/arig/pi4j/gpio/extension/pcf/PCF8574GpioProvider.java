package org.arig.pi4j.gpio.extension.pcf;
...
import org.arig.pi4j.gpio.extension.base.MonitorGpioProvider;
import org.arig.pi4j.gpio.extension.base.MonitorGpioProviderBase;
import org.arig.pi4j.gpio.extension.base.MonitoringStateDeviceBase;
...
public class PCF8574GpioProvider extends MonitorGpioProviderBase implements MonitorGpioProvider {
    ...
    public static final String NAME = "org.arig.pi4j.gpio.extension.pcf.PCF8574GpioProvider";
    ...
    public PCF8574GpioProvider(I2CBus bus, int address, GpioPinDigitalInput irqPin, boolean disableMonitor) throws IOException {
        ...
        if (!disableMonitor) {
            monitor = new GpioStateMonitor(device, irqPin);
            ((GpioStateMonitor) monitor).start();
        }
    }
