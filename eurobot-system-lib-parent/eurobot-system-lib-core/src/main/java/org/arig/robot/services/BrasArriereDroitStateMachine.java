...
public class BrasArriereDroitStateMachine extends AbstractBrasStateMachine {

    public BrasArriereDroitStateMachine(ConfigBras configBras) {
        super("Bras arriere droit");
