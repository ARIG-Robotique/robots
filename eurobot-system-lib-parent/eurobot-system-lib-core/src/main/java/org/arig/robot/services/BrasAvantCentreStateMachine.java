...
public class BrasAvantCentreStateMachine extends AbstractBrasStateMachine {

    public BrasAvantCentreStateMachine(ConfigBras configBras) {
        super("Bras avant centre");
