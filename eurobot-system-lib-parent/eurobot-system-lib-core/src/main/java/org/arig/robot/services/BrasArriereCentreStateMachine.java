...
public class BrasArriereCentreStateMachine extends AbstractBrasStateMachine {

    public BrasArriereCentreStateMachine(ConfigBras configBras) {
        super("Bras arriere centre");
