...
public class BrasService {
    ...
    public void setBrasAvant(PositionBras positionBras) {
        setBrasByName(Bras.AVANT_GAUCHE, positionBras, 0, false);
        setBrasByName(Bras.AVANT_CENTRE, positionBras, 0, false);
        setBrasByName(Bras.AVANT_DROIT, positionBras, 0, true);
    }

    public void setBrasArriere(PositionBras positionBras) {
        setBrasByName(Bras.ARRIERE_GAUCHE, positionBras, 0, false);
        setBrasByName(Bras.ARRIERE_CENTRE, positionBras, 0, false);
        setBrasByName(Bras.ARRIERE_DROIT, positionBras, 0, true);
    }

    public void setBrasAvant(PointBras pointBras) {
        setBras(Bras.AVANT_GAUCHE, pointBras, 0, false);
        setBras(Bras.AVANT_CENTRE, pointBras, 0, false);
        setBras(Bras.AVANT_DROIT, pointBras, 0, true);
    }

    public void setBrasArriere(PointBras pointBras) {
        setBras(Bras.ARRIERE_GAUCHE, pointBras, 20, false);
        setBras(Bras.ARRIERE_CENTRE, pointBras, 20, false);
        setBras(Bras.ARRIERE_DROIT, pointBras, 20, true);
    }
