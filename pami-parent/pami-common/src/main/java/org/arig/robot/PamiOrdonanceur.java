...
public class PamiOrdonanceur extends AbstractOrdonanceur {
    ...
    @Autowired
    private PamiRobotServosService odinServosService;
    ...
    private void choixEquipeStrategy() {
        ...
        do {
            ...
            if (robotStatus.groupOk()) {
                ...
                pamiRobotStatus.option1(pamiEcranService.config().hasOption(EurobotConfig.OPTION_1));
