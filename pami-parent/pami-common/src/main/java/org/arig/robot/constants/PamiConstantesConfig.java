...
public interface PamiConstantesConfig {
  ...
  int pathFindingAngle = 70;
  int pathFindingAngleSafe = 90;
  int pathFindingSeuilProximite = 300;
  int pathFindingSeuilProximiteSafe = 350;
  int pathFindingSeuilProximiteArig = 200;
