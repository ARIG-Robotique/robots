...
public class PamiRobotContext {
    ...
    public I2CManager i2cManager(I2CBus i2cBus) throws IOException {
        ...
        final I2CManagerDevice<I2CDevice> pca9685 = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.PCA9685_DEVICE_NAME)
                .device(i2cBus.getDevice(PamiConstantesI2C.PCA9685_ADDRESS))
                .build();
        final I2CManagerDevice<I2CDevice> pcfAlim = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.PCF_ALIM_DEVICE_NAME)
                .device(i2cBus.getDevice(PamiConstantesI2C.PCF_ALIM_ADDRESS))
                .build();
        final I2CManagerDevice<I2CDevice> pcf1 = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.PCF1_DEVICE_NAME)
                .device(i2cBus.getDevice(PamiConstantesI2C.PCF1_ADDRESS))
                .build();
        final I2CManagerDevice<I2CDevice> pcf2 = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.PCF2_DEVICE_NAME)
                .device(i2cBus.getDevice(PamiConstantesI2C.PCF2_ADDRESS))
                .build();
        final I2CManagerDevice<I2CDevice> sd21 = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.SERVO_DEVICE_NAME)
                .device(i2cBus.getDevice(PamiConstantesI2C.SD21_ADDRESS))
                .build();
        final I2CManagerDevice<I2CDevice> codeurMoteurDroit = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.CODEUR_MOTEUR_DROIT)
                .device(i2cBus.getDevice(PamiConstantesI2C.CODEUR_DROIT_ADDRESS))
                .build();
        final I2CManagerDevice<I2CDevice> codeurMoteurGauche = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.CODEUR_MOTEUR_GAUCHE)
                .device(i2cBus.getDevice(PamiConstantesI2C.CODEUR_GAUCHE_ADDRESS))
                .build();
        /*final I2CManagerDevice<I2CDevice> alimMesure = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(IPamiConstantesI2C.ALIM_MESURE_DEVICE_NAME)
                .device(i2cBus.getDevice(IPamiConstantesI2C.ALIM_MESURE_ADDRESS))
                .scanCmd(new byte[]{0x00})
                .build();*/
        final I2CManagerDevice<I2CDevice> controlleurPompes = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.VACUUM_CONTROLLER_DEVICE_NAME)
                .device(i2cBus.getDevice(PamiConstantesI2C.VACUUM_CONTROLLER_ADDRESS))
                .scanCmd(new byte[]{0x00, 0x00})
                .build();
        final I2CManagerDevice<I2CDevice> mux = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.MULTIPLEXEUR_I2C_NAME)
                .device(i2cBus.getDevice(PamiConstantesI2C.MULTIPLEXEUR_I2C_ADDRESS))
                .build();
        final I2CManagerDevice<I2CDevice> couleurVentouseBas = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.COULEUR_VENTOUSE_BAS_NAME)
                .device(i2cBus.getDevice(TCS34725ColorSensor.TCS34725_ADDRESS))
                .multiplexerDeviceName(PamiConstantesI2C.MULTIPLEXEUR_I2C_NAME)
                .multiplexerChannel(PamiConstantesI2C.COULEUR_VENTOUSE_BAS_MUX_CHANNEL)
                .build();
        final I2CManagerDevice<I2CDevice> couleurVentouseHaut = I2CManagerDevice.<I2CDevice>builder()
                .deviceName(PamiConstantesI2C.COULEUR_VENTOUSE_HAUT_NAME)
                .device(i2cBus.getDevice(TCS34725ColorSensor.TCS34725_ADDRESS))
                .multiplexerDeviceName(PamiConstantesI2C.MULTIPLEXEUR_I2C_NAME)
                .multiplexerChannel(PamiConstantesI2C.COULEUR_VENTOUSE_HAUT_MUX_CHANNEL)
                .build();
    ...
    public SD21Servos servos() {
        return new SD21Servos(PamiConstantesI2C.SERVO_DEVICE_NAME);
    }

    @Bean
    public ARIGI2C2WheelsEncoders encoders() {
        final ARIGI2C2WheelsEncoders encoders = new ARIGI2C2WheelsEncoders(PamiConstantesI2C.CODEUR_MOTEUR_GAUCHE, PamiConstantesI2C.CODEUR_MOTEUR_DROIT);
    ...
    public ARIGVacuumController vacuumController() {
        return new ARIGVacuumController(PamiConstantesI2C.VACUUM_CONTROLLER_DEVICE_NAME);
    }

    /*
    @Bean
    public ARIG2ChannelsAlimentationSensor alimentationSensor() {
        return new ARIG2ChannelsAlimentationSensor(IPamiConstantesI2C.ALIM_MESURE_DEVICE_NAME);
    }
    */

    @Bean
    public TCS34725ColorSensor couleurVentouseBas() {
        return new TCS34725ColorSensor(PamiConstantesI2C.COULEUR_VENTOUSE_BAS_NAME, IntegrationTime.TCS34725_INTEGRATIONTIME_154MS, Gain.TCS34725_GAIN_1X);
    }

    @Bean
    public TCS34725ColorSensor couleurVentouseHaut() {
        return new TCS34725ColorSensor(PamiConstantesI2C.COULEUR_VENTOUSE_HAUT_NAME, IntegrationTime.TCS34725_INTEGRATIONTIME_154MS, Gain.TCS34725_GAIN_1X);
    }

    @Bean
    public TCA9548MultiplexerI2C mux(I2CManager i2CManager) {
        final TCA9548MultiplexerI2C mux = new TCA9548MultiplexerI2C(PamiConstantesI2C.MULTIPLEXEUR_I2C_NAME);
        i2CManager.registerMultiplexerDevice(PamiConstantesI2C.MULTIPLEXEUR_I2C_NAME, mux);
        return mux;
    }
    ...
    public PCA9685GpioProvider pca9685GpioControler(I2CBus bus) {
        return new PCA9685GpioProvider(bus, PamiConstantesI2C.PCA9685_ADDRESS, new BigDecimal(200));
    }
