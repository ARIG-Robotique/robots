...
public class NerellShellInputReader {
  ...
  public NerellShellInputReader(LineReader lineReader) {
    this(lineReader, null);
  }

  public NerellShellInputReader(LineReader lineReader, Character mask) {
