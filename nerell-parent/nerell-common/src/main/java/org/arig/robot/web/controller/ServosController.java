...
public class ServosController extends AbstractServosController {
    ...
    static {
        servoConfigs.add(new ServoGroup()
                ...
                .servo(new ServoConfig()
                        .setId(IConstantesServos.POUSSOIR_DROITE)
                        .setName("Poussoir droite")
                        .position("Ouvert", IConstantesServos.POS_POUSSOIR_DROITE_OUVERT)
                        .position("Fermé", IConstantesServos.POS_POUSSOIR_DROITE_FERME)
                )
                .servo(new ServoConfig()
                        .setId(IConstantesServos.POUSSOIR_GAUCHE)
                        .setName("Poussoir gauche")
                        .position("Ouvert", IConstantesServos.POS_POUSSOIR_GAUCHE_OUVERT)
                        .position("Fermé", IConstantesServos.POS_POUSSOIR_GAUCHE_FERME)
                )
        );
        ...
        servoConfigs.add(new ServoGroup()
                ...
                .servo(new ServoConfig()
                        ...
                        .position("Bas", IConstantesServos.POS_ASCENSEUR_ARRIERE_BAS)
                )
                .servo(new ServoConfig()
