...
public interface IConstantesServos {
    ...
    int PIVOT_VENTOUSE_DROIT_CAROUSEL_VERTICAL = 470;
    int PIVOT_VENTOUSE_DROIT_CAROUSEL_SORTIE = 1130;
    int PIVOT_VENTOUSE_DROIT_FACADE = 1370;
    int PIVOT_VENTOUSE_DROIT_TABLE = 2300;
    ...
    int ASCENSEUR_GAUCHE_GOLD = 1710;
