...
public interface IConstantesServos {
    ...
    int PINCE_SERRAGE_PALET_DROIT_LOCK = 440; //2180;
    ...
    int PIVOT_VENTOUSE_DROIT_VOMI = 1940;
    int PIVOT_VENTOUSE_DROIT_TABLE = 2500;

    int PIVOT_VENTOUSE_GAUCHE_CAROUSEL_VERTICAL = 2400;
    int PIVOT_VENTOUSE_GAUCHE_CAROUSEL_SORTIE = 1700;
    int PIVOT_VENTOUSE_GAUCHE_FACADE = 1500;
    int PIVOT_VENTOUSE_GAUCHE_VOMI = 1080;
    int PIVOT_VENTOUSE_GAUCHE_TABLE = 530;
