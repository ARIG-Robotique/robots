...
public interface IConstantesServos {
    ...
    long WAIT_PINCE_SERRAGE_PALET = 1500;
    long WAIT_PIVOT_VENTOUSE = 1500;
    long WAIT_ASCENSEUR_VENTOUSE = 1500;
    long WAIT_PORTE_BARILLET = 1500;
    long WAIT_TRAPPE_MAGASIN = 1500;
    long WAIT_EJECTION_MAGASIN = 1500;
    long WAIT_POUSSE_ACCELERATEUR = 1500;
