...
public interface IConstantesServos {
    ...
    int POS_MOUSTACHE_GAUCHE_POUSSETTE = 1340;
    int POS_MOUSTACHE_GAUCHE_FERME = 730;
    int POS_MOUSTACHE_DROITE_OUVERT = 990;
    int POS_MOUSTACHE_DROITE_POUSSETTE = 1490;
    ...
    int POS_PINCE_AVANT_1_PRISE = 1590;
    int POS_PINCE_AVANT_1_FERME = 1100;
    int POS_PINCE_AVANT_2_OUVERT = 1110;
    int POS_PINCE_AVANT_2_PRISE = 1290;
    int POS_PINCE_AVANT_2_FERME = 1650;
    int POS_PINCE_AVANT_3_OUVERT = 2000;
    int POS_PINCE_AVANT_3_PRISE = 1760;
    int POS_PINCE_AVANT_3_FERME = 1450;
    int POS_PINCE_AVANT_4_OUVERT = 1210;
    int POS_PINCE_AVANT_4_PRISE = 1380;
