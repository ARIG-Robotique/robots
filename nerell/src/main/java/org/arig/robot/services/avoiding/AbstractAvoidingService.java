...
public abstract class AbstractAvoidingService implements IAvoidingService, InitializingBean {
    ...
    public void process() {
        try {
            ...
            int rawAvantGauche = analogInput.readCapteurValue(IConstantesGPIO.GP2D_AVANT_GAUCHE);
            int rawAvantDroit = analogInput.readCapteurValue(IConstantesGPIO.GP2D_AVANT_DROIT);
            int rawLateralAvantGauche = analogInput.readCapteurValue(IConstantesGPIO.GP2D_AVANT_LATERAL_GAUCHE);
            int rawLateralAvantDroit = analogInput.readCapteurValue(IConstantesGPIO.GP2D_AVANT_LATERAL_DROIT);
